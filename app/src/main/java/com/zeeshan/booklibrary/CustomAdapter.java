...
//        return holder;
    ...
    {
//        holder.book_title_txt.setText(book_title[position]);
//        holder.book_id_txt.setText(book_id[position]);
//        holder.book_author_txt.setText(book_author[position]);
//        holder.book_pages_txt.setText(book_pages[position]);
